...
class WxBrowser:
    ...
    def __init__(self):
        ...
        self.more_button = self.control.PaneControl(
            searchDepth=1, ClassName=""
        ).MenuItemControl(Name="更多")
        self.close_button = self.control.PaneControl(
            searchDepth=1, ClassName=""
        ).ButtonControl(Name="关闭")
